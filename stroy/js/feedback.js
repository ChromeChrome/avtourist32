      ...
      $(document).ready(function(){
         ...
         $('input#name, input#tel, textarea#message').unbind().blur( function(){
           ...
           switch(id)
           {
               ...
               case 'tel':
                   ...
                   {
                      $(this).removeClass('not_error').addClass('error');
                      $(this).next('.error-box').html('&bull; поле "Ваш телефон" обязательно для заполнения<br> &bull; поле должно содержать правильный телефонный номер<br> (например: +78888888888)')
                                                 .css('color','red')
                                                 .animate({'paddingLeft':'10px'},400)
                                                 .animate({'paddingLeft':'5px'},400);
                   }
